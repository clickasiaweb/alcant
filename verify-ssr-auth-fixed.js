...
try {
  ...
  hasAppProviders = appContent.includes('SupabaseAuthProvider') && appContent.includes('SupabaseCartProvider');
...
try {
  ...
  hasServerAuth = serverAuthContent.includes('getServerSideAuth') && serverAuthContent.includes('requireAuth');
