...
const SubcategoryUpload = () => {
  ...
  const downloadTemplate = async () => {
    try {
      console.log('Starting Subcategory CSV template download...');
      
      const response = await fetch('/api/subcategories/csv/template');
      ...
      console.log('Subcategory CSV Blob size:', blob.size);
      ...
      setTimeout(() => {
        ...
        console.log('Subcategory CSV download cleanup completed');
      }, 1000);
      
    } catch (err) {
      console.error('Subcategory CSV template download error:', err);
  ...
  const handleUpload = async () => {
    ...
    try {
      const response = await fetch('/api/subcategories/csv/upload', {
        method: 'POST',
        body: formData
      });
    ...
    <div className="max-w-4xl mx-auto p-6">
      <div className="bg-white rounded-lg shadow-lg">
        ...
        <div className="border-b border-gray-200 px-6 py-4">
          <h1 className="text-2xl font-bold text-gray-900">Subcategory Upload</h1>
          <p className="text-gray-600 mt-1">
            Upload subcategories using Excel files (linked to main categories)
          </p>
        </div>
        ...
        <div className="px-6 py-6">
            ...
            <div className="text-center py-8">
              <div className="mb-6">
                ...
                <p className="text-gray-600 max-w-md mx-auto">
                  Download the pre-formatted Excel template to add your subcategories.
                </p>
              </div>
              ...
              <div className="bg-gray-50 rounded-lg p-4 text-left max-w-2xl mx-auto mb-6">
                ...
                <ul className="space-y-2 text-sm text-gray-600">
                  <li className="flex items-start">
                    ...
                    <span><strong>Subcategories Sheet:</strong> Subcategories with parent category links</span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-purple-500 mr-2">•</span>
              ...
              <div className="bg-amber-50 border border-amber-200 rounded-lg p-4 max-w-2xl mx-auto mb-6">
                ...
                <ul className="space-y-1 text-sm text-amber-800">
                  ...
                  <li>• Each subcategory must be linked to a valid parent category</li>
                  <li>• Duplicate subcategory names within the same category are not allowed</li>
                </ul>
              </div>
          ...
          {uploadStep === 2 && (
            <div>
              ...
              >
                ...
                {isDragActive ? (
                  <p className="text-purple-600">Drop the Excel file here...</p>
                ) : (
                  <div>
          ...
          {uploadStep === 3 && (
            <div className="text-center py-12">
              <div className="mx-auto w-16 h-16 bg-purple-100 rounded-full flex items-center justify-center mb-4">
                <FiLoader className="text-purple-600 animate-spin" size={32} />
              </div>
              <h2 className="text-xl font-semibold text-gray-900 mb-2">
                Processing Your File
              </h2>
              <p className="text-gray-600">
                Please wait while we process your subcategories...
              </p>
          ...
          {uploadStep === 4 && uploadResults && (
            <div>
              <div className="mb-6">
                ...
                <p className="text-gray-600">
                  Your subcategories have been processed successfully.
                </p>
              </div>
                ...
                <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-green-700">Subcategories Created</p>
                    </div>
                  </div>
                </div>
