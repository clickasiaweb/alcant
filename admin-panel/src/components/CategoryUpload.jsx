...
const CategoryUpload = () => {
  ...
  const downloadTemplate = async () => {
    try {
      ...
      const response = await fetch('/api/categories/csv/template');
      ...
      console.error('CSV template download error:', err);
  ...
  const handleUpload = async () => {
    ...
    try {
      const response = await fetch('/api/categories/csv/upload', {
        method: 'POST',
        body: formData
      });
    ...
    <div className="max-w-4xl mx-auto p-6">
      <div className="bg-white rounded-lg shadow-lg">
        ...
        <div className="border-b border-gray-200 px-6 py-4">
          <h1 className="text-2xl font-bold text-gray-900">Category Upload</h1>
          <p className="text-gray-600 mt-1">
            Upload main categories using CSV files
          </p>
        </div>
            ...
            <div className="text-center py-8">
              <div className="mb-6">
                ...
                <p className="text-gray-600 max-w-md mx-auto">
                  Download the pre-formatted CSV template to add your main categories.
                </p>
              </div>
              ...
              <div className="bg-gray-50 rounded-lg p-4 text-left max-w-2xl mx-auto mb-6">
                ...
                <ul className="space-y-2 text-sm text-gray-600">
                  <li className="flex items-start">
                    ...
                    <span><strong>CSV Headers:</strong> Category Name, Category Slug, Description, Image URL, Sort Order, Is Active</span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-blue-500 mr-2">•</span>
                ...
                <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-green-700">Categories Created</p>
                    </div>
                  </div>
                </div>
