...
('iPhone 15 Pro Max Cases', 'iphone-15-pro-max-cases', 
 (SELECT id FROM sub_subcategories WHERE name = 'Apple Watch Bands' LIMIT 1),
 'Premium cases for iPhone 15 Pro Max', 1),
('iPhone 15 Pro Cases', 'iphone-15-pro-cases', 
 (SELECT id FROM sub_subcategories WHERE name = 'Apple Watch Bands' LIMIT 1),
 'Premium cases for iPhone 15 Pro', 2),
('Samsung Galaxy S24 Cases', 'samsung-galaxy-s24-cases', 
 (SELECT id FROM sub_subcategories WHERE name = 'Samsung Watch Bands' LIMIT 1),
 'Premium cases for Samsung Galaxy S24', 1),
('Google Pixel 8 Cases', 'google-pixel-8-cases', 
 (SELECT id FROM sub_subcategories WHERE name = 'Universal Watch Bands' LIMIT 1),
 'Premium cases for Google Pixel 8', 1);
