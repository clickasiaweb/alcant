...
const CartTestSimple = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Simple Header without Layout */}
      <div className="bg-white shadow-sm border-b">
        <div className="max-w-6xl mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-2xl font-bold text-gray-900">Cart Test (No API)</h1>
              <p className="text-gray-600 mt-1">Test cart functionality without API calls</p>
            </div>
            <CartIcon />
          </div>
        </div>
          ...
          <div className="flex items-start space-x-3">
            ...
            <div className="flex-1">
              ...
              <ul className="text-sm text-blue-700 mt-1 space-y-1">
                ...
                <li>• No API calls are made in this test page</li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        <div className="mb-8">
          <h2 className="text-xl font-semibold text-gray-900 mb-2">Test Products</h2>
