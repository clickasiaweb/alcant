...
const FeaturedProductsSection = dynamic(
  () => import("../components/FeaturedProductsSection"),
  {
    ssr: false,
    loading: () => (
...
const ΛʟcΛɴᴛHome = ({ homeContent = {} }) => {
  ...
  return (
    ...
    >
      ...
      <section
        className="relative w-full h-[350px] sm:h-[350px] md:h-[420px] mb-10 sm:mb-16 bg-gradient-to-r from-blue-600 to-blue-800 flex items-center justify-center overflow-hidden"
        style={{
          backgroundImage: homeContent.hero?.backgroundImage
            ? `url(${homeContent.hero.backgroundImage})`
            : undefined,
          ...
          <div className="flex flex-wrap justify-center items-center gap-4 sm:gap-6 md:gap-8 lg:gap-12">
            {homeContent.asSeenIn?.items?.length > 0 ? (
              homeContent.asSeenIn.items.map((item, index) => (
                <div
                  key={index}
                  className="text-gray-400 font-bold text-sm sm:text-base lg:text-xl"
                >
                  {item.title}
                </div>
              ))
              ...
              ? homeContent.collections.items.map((item, index) => {
                  ...
                  return (
                    <Link
                      ...
                      onClick={(e) => {
                        console.log(
                          "🖱️ Collection clicked, navigating to:",
                          getCollectionLink(item),
                        );
                      }}
                    >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-base text-gray-600 mb-8">
                {homeContent.newWeHave?.content ||
                  "Discover our latest collection of premium ΛʟcΛɴᴛ accessories, designed to elevate your everyday luxury experience."}
              </p>
              <Link
        ...
        <div className="container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="order-2 lg:order-1">
              ...
              <p className="text-base text-gray-600 mb-8">
                {homeContent.automotive?.content ||
                  "Experience the luxury of ΛʟcΛɴᴛ in your vehicle. Our premium automotive accessories provide the perfect combination of style, comfort, and durability for discerning car enthusiasts."}
              </p>
              <Link
                href={
                  homeContent.automotive?.buttonLink || "/solutions/automotive"
                }
                className="inline-flex items-center bg-primary-900 text-white px-6 py-2.5 rounded-lg font-semibold hover:bg-primary-800 transition-colors"
              >
                    ...
                    <div className="flex items-center mb-4">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-gray-600">
                          {item.description || "Professional Title"}
                        </p>
                      </div>
                    </div>
                    <p className="text-sm text-gray-700">
                      {item.link || "Tuner description"}
                    </p>
                  </div>
                ))
              : tuners.map((tuner) => (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-base text-primary-100 mb-8">
                {homeContent.partner?.content ||
                  "We are honored to partner with Conkero.com to bring you the finest ΛʟcΛɴᴛ products and accessories. Together, we deliver exceptional quality and service to our valued customers."}
              </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="text-base text-gray-600 mb-6">
                {homeContent.team?.content ||
                  "Our dedicated team of professionals is committed to bringing you the finest ΛʟcΛɴᴛ products and exceptional customer service. With years of experience in the luxury goods industry, we understand what it takes to deliver excellence."}
              </p>
              <p className="text-base text-gray-600 mb-8">
                From our skilled craftsmen to our knowledgeable sales team,
                every member of Team ΛʟcΛɴᴛ shares a passion for quality and a
