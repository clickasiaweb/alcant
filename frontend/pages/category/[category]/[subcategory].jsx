  ...
  return (
    <Layout>
      <Head>
        ...
        <meta name="keywords" content={`${meta.title}, ΛʟcΛɴᴛ, premium accessories, ${category}, ${subcategory || ''}`} />
        <meta property="og:title" content={`${meta.title} - ΛʟcΛɴᴛ`} />
        <meta property="og:description" content={meta.description} />
        <meta property="og:type" content="website" />
        <meta property="og:url" content={`https://www.ΛʟcΛɴᴛ.com/category/${category}${subcategory ? `/${subcategory}` : ''}`} />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content={`${meta.title} - ΛʟcΛɴᴛ`} />
        <meta name="twitter:description" content={meta.description} />
        <link rel="canonical" href={`https://www.ΛʟcΛɴᴛ.com/category/${category}${subcategory ? `/${subcategory}` : ''}`} />
      </Head>
